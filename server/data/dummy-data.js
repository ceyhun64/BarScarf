...
async function populate() {
  ...
  await User.bulkCreate([
    ...
    { name: "Bulent", email: "bulent@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Hasan", email: "hasan@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Done", email: "done@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Zeynep", email: "zeynep@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Hasan Ali", email: "hasanali@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Ayse", email: "ayse@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Mehmet", email: "mehmet@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Ali", email: "ali@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Fatma", email: "fatma@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Ahmet", email: "ahmet@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Elif", email: "elif@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
    { name: "Murat", email: "murat@example.com", password: await bcrypt.hash("Ceycey.123", 10), isAdmin: 0 },
  ]);
  ...
  await ProductSize.bulkCreate([
    ...
    { productId: 5, sizeId: 3 },
    { productId: 5, sizeId: 4 },

    { productId: 6, sizeId: 5 },
    { productId: 6, sizeId: 6 },

    { productId: 7, sizeId: 1 },
    { productId: 7, sizeId: 2 },

    { productId: 8, sizeId: 3 },
    { productId: 8, sizeId: 4 },

    { productId: 9, sizeId: 5 },
    { productId: 9, sizeId: 6 },

    { productId: 10, sizeId: 1 },
    { productId: 10, sizeId: 2 },
  ...
  await CartProduct.bulkCreate([
    { id: 1, quantity: 1, productId: 1, sizeId: 2, cartId: 1, price: 1000 },
    { id: 2, quantity: 3, productId: 2, sizeId: 3, cartId: 2, price: 1000 },
    { id: 3, quantity: 1, productId: 3, sizeId: 4, cartId: 3, price: 1000 },
    { id: 4, quantity: 2, productId: 4, sizeId: 1, cartId: 4, price: 1000 },
    { id: 5, quantity: 1, productId: 5, sizeId: 2, cartId: 5, price: 1000 },
  ]);
  ...
  await OrderProduct.bulkCreate([
    { id: 1, quantity: 1, productId: 1, sizeId: 2, orderId: 1, priceAtPurchase: 99.99 },
    { id: 2, quantity: 3, productId: 2, sizeId: 3, orderId: 2, priceAtPurchase: 99.99 },
    { id: 3, quantity: 1, productId: 3, sizeId: 4, orderId: 3, priceAtPurchase: 99.99 },
    { id: 4, quantity: 2, productId: 4, sizeId: 1, orderId: 4, priceAtPurchase: 99.99 },
  ]);
