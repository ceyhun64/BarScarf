...
export default function Topbar() {
    ...
    const message = "Mağazaya ücretsiz teslimat • Ücretsiz iade • Bugün sepette ekstra %10 indirim • Yeni sezon ürünlerinde %20 fırsat • ";
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-1 text-end">
                                <i className="bi bi-x-lg" style={closeButtonStyle} onClick={closeTopbar}></i>
                            </div>
                        </div>
                    </div>
                </div>
