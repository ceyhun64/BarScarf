            ...
            <div className="row align-items-center">
                ...
                <div className="col-md-6 mb-4 mb-md-0">
                    ...
                    <p className="lead text-muted mb-4">
                        Moda, tarz ve kaliteyi bir arada sunan <strong className="fw-bold text-danger">MyShop</strong>, kıyafet ve aksesuar alışverişinde benzersiz bir deneyim sunuyor. Müşterilerimize her sezonun en trend parçalarını sunarak, stilinizi tamamlamanıza yardımcı olmak için buradayız. Geniş ürün yelpazemizle, her tarza hitap eden modern ve şık seçenekler sunuyoruz.
                    </p>
                    <p className="lead text-muted mb-4">
                    ...
                    <p className="lead text-muted mb-4">
                        Her yaştan ve her zevke hitap eden kıyafetlerimizi keşfedin ve kendinize yeni bir tarz yaratın! <strong className="fw-bold text-danger">MyShop</strong> ile her zaman şık ve rahat olmanın keyfini çıkarın.
                    </p>
                </div>
