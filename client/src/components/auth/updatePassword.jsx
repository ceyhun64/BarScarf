...
export default function UpdatePassword() {
    ...
    const handleUpdatePassword = async (e) => {
        e.preventDefault();
        try {
            const action = await dispatch(updatePasswordThunk({token, password, newPassword, againNewPassword })).unwrap();
                    ...
                    <div className="card p-4 shadow-lg">
                        ...
                        <form onSubmit={handleUpdatePassword}>{/* formun submit edilmesi için handleUpdatePassword fonksiyonunu çağırıyoruz */}
                            ...
                            <div className="form-group mb-3">
                                <label htmlFor="password" className="form-label">Eski Şifre</label>
                                <input
                                    id="password"
                                    type="password"
                                    className="form-control"
                                    placeholder="Eski Şifre"
                                    value={password}//password stateini alıyoruz
                            ...
                            <div className="form-group mb-3">
                                ...
                                <input
                                    ...
                                    value={newPassword}//newPassword stateini alıyoruz
                            ...
                            <div className="form-group mb-3">
                                ...
                                <input
                                    ...
                                    value={againNewPassword}//againNewPassword stateini alıyoruz
