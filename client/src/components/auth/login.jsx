                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="text-end mb-3">
                                <Link to="/password-email" className="text-decoration-none" style={{ fontWeight: "bold", color: "#D3AF37" }}>
                                    Şifremi Unuttum
                                </Link>
                            </div>
                            ...
                            <div className="text-center">
                                <label className='me-3'>Hesabın yok mu?</label>
                                <Link to="/register" className="btn btn-outline-success">Kayıt ol</Link>
                            </div>
                        </form>
                    </div>
                </div>
